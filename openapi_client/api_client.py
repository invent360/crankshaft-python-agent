...
class Endpoint(object):
    ...
    def __call__(self, *args, **kwargs):
        ...
        api_instance = PostsApi()
        api_instance.create_posts  # this is an instance of the class Endpoint
        api_instance.create_posts()  # this invokes api_instance.create_posts.__call__()
        which then invokes the callable functions stored in that endpoint at
        api_instance.create_posts.callable or self.callable in this class
